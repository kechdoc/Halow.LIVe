# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for https://www.youtube.com/user/Halowdif
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "Halowdif"

# Entry point
def run():
    plugintools.log("Halowdif.run")
...
def main_list(params):
    plugintools.log("Halowdif.main_list "+repr(params))
